...
- [x] **Step 3: Implement immutable dataclasses and enums**
...
- [x] **Step 4: Route lifecycle and heartbeat through the contract**
...
- [x] **Step 1: Write failing ordering and safety tests**
...
- [x] **Step 3: Implement queue-first input delivery**
...
- [x] **Step 1: Write failing same-cwd isolation tests**
...
- [x] **Step 3: Persist identity fields**
...
- [x] **Step 4: Pin transcript discovery**
...
- [x] **Step 1: Write failing event normalization tests**
...
- [x] **Step 3: Return ProviderEvent instances from both adapters**
...
- [x] **Step 4: Add a compatibility reducer**
...
- [x] **Step 1: Write failing channel parity tests**
...
- [x] **Step 1: Write failing inbound parity tests**
...
- [x] **Step 3: Implement channel normalization adapters**
...
- [x] **Step 4: Delegate legacy handlers to adapters**
...
- [x] **Step 1: Write failing hook parsing and deduplication tests**
...
- [x] **Step 3: Implement a local hook spool**
...
- [x] **Step 4: Implement idempotent hook configuration**
...
- [x] **Step 5: Consume hooks in the Claude adapter**
...
- [x] **Step 1: Write failing mode and parity tests**
...
- [x] **Step 1: Add fake CLI tmux E2E tests**
...
- [x] **Step 3: Run dedicated live tmux smoke sessions**
...
- [x] **Step 4: Shadow production bindings**
...
- [x] **Step 5: Enable V2 and verify rollback**
...
- [x] **Step 7: Push the verified branch**

Run: `git push origin productization-prep`

Expected: local HEAD and `origin/productization-prep` resolve to the same commit.

## Verification Evidence (2026-07-10 UTC)

- Automated: `118 passed`; Ruff and `git diff --check` clean.
- Fake-provider tmux E2E: Claude/Codex × Telegram/Feishu 2×2 matrix passed.
- Dedicated live tmux: ordered input, same-cwd target isolation, pane respawn/reattach,
  and provider footer parsing passed in `tmuxbot-smoke-claude` / `tmuxbot-smoke-codex`.
- Production shadow: five active bindings observed across two 30-second lifecycle intervals;
  zero shadow mismatches, zero launch-abort/refusal events, and zero watchdog start injection.
- Cutover: `on → off → on` service restart sequence passed; final mode is `on` with managed
  Claude hooks enabled. Telegram is live for Claude and Codex; Feishu parity is covered by
  contract and E2E tests because no Feishu binding is configured on this host.
